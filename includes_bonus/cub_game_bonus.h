...
/*   Updated: 2025/04/30 10:58:21 by racoutte         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				draw_vertical_line(t_game_data *game_data,
						t_image_data *img, int x, t_ray *ray);
...
void				draw_wall(t_game_data *game_data, t_image_data *img,
						t_ray *ray, int x);
