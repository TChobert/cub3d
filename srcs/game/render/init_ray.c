...
void	init_ray(t_game_data *game_data, t_ray *ray, size_t	x)
{
	...
	ray->ray_dir.x = game_data->character.direction.x + game_data->character.plane.x * camera_x;
	ray->ray_dir.y = game_data->character.direction.y + game_data->character.plane.y * camera_x;
}
